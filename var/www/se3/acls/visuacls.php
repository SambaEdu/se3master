...
if ($repertoire=="") { $repertoire=$_GET[repertoire]; }
$type_fich=$_POST[type_fich];
if ($type_fich=="") {$type_fich=$_GET[type_fich]; }
$noms = $_POST['noms'];
...
$valide = $_POST['valide'];
$nouveaulecture = $_POST['nouveaulecture'];
$nouveauecriture = $_POST['nouveauecriture'];
$nouveauexecution = $_POST['nouveauexecution'];
$nouveauheritage = $_POST['nouveauheritage'];
