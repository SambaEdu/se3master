...
#         dbhostinvent=`cat /var/www/se3/includes/dbconfig.inc.php | grep "dbhostinvent=" | cut -d = -f 2 |cut -d \" -f 2`
#         dbnameinvent=`cat /var/www/se3/includes/dbconfig.inc.php | grep "dbnameinvent=" | cut -d = -f 2 |cut -d \" -f 2`
#         dbuserinvent=`cat /var/www/se3/includes/dbconfig.inc.php | grep "dbuserinvent=" | cut -d = -f 2 |cut -d \" -f 2`
#         dbpassinvent=`cat /var/www/se3/includes/dbconfig.inc.php | grep "dbpassinvent=" | cut -d = -f 2 |cut -d \" -f 2`
