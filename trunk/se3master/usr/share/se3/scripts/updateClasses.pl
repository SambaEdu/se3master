...
#       Denis Bonnenfant (denis.bonnenfant@diderot.org) 3 septembre 2008 : CrÃ©ation du rÃ©eprtoire Ã©lÃ¨ve avant de dmigrer les dossiers de l'annÃ©e d'avant
#       
...
#                print "r&#233;pertoire '$oldeleve' ignor&#233;.<br>\n"; 
   ...
   Update_Eleve($Classe) == 0 or warn " Erreur : impossible de mettre Ã  jour pour$Classe<br>\n>";
}
exit 0 ;
