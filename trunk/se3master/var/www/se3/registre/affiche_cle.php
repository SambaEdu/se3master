...
switch ($modif)
{
	...
	if (substr_count($OS, "Win9x") > 0) { echo "SELECTED"; }
	echo ">Type Windows 9X</option>";

	echo "<option value=\"2000\" ";
	if (substr_count($OS, "2000") > 0) { echo "SELECTED"; }
	echo ">2000</option>";

	echo "<option value=\"XP\" ";
	if (substr_count($OS, "XP") > 0) { echo "SELECTED"; }
	echo ">XP</option>";

	echo "<option value=\"Vista\" ";
	if (substr_count($OS, "Vista") > 0) { echo "SELECTED"; }
	echo ">Vista</option>";

	echo "<option value=\"Seven\" ";
	if (substr_count($OS, "Seven") > 0) { echo "SELECTED"; }
	echo ">Seven</option>";
