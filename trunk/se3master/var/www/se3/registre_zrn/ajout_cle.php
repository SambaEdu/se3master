...
switch ($ajout) {
	...
	//$nombre1 : utise pour recuperer le nombre de resultats de la recherche
    	...
    	echo "<table border=\"1\" ><tr><td><img src=\"/elements/images/help.png\" alt=\"Aide\" title=\"$row[5]\" width=\"16\" height=\"18\" border=\"0\" /></td><td><DIV ALIGN=CENTER>".gettext("Intitul&#233")."</DIV></td><td>OS</td><td><DIV ALIGN=CENTER>".gettext("Valeur (defaut)")."</DIV></td><td>".gettext("Exporter")."</td></tr>";
	...
	$list= split ("\r\n", $brutout, 15);
    	...
    	if (!$num) {
    		...
    		echo "<tr><td>".gettext("OS d&#233tect&#233")." :</td><td><select name=\"OS\" size=\"1\"><option value=\"TOUS\" ";
    		...
    		echo ">Type Windows XP</option></select></td></tr>";
		...
		while ($row1=mysql_fetch_row($resultat1)) { 
			...
			echo "<tr><td>".gettext("Antidote (si cl&#233 de restriction)SUPPR pour supprimer la cl&#233")."</td><td><input type=\"text\" name=\"antidote\" value=\"$valeur\" size=\"20\" /></td></tr>";
	...
	echo "<tr><td>".gettext("Valeur par d&#233;faut")."</td><td> <INPUT TYPE=\"text\" NAME=\"Valeur\" size=\"100\"></td></tr>";
     	echo "<tr><td>".gettext("Antidote (si cl&#233; de restriction)Si l'antidote est la suppression de la cl&#233; indiquez SUPPR");
	echo "</td><td><input type=\"text\" name=\"antidote\" value=\"SUPPR\" size=\"20\" /></td>";
	...
	echo "<td> <SELECT NAME=\"OS\"><OPTION value=\"TOUS\">".gettext("Tous OS")."<OPTION value=\"95\">Windows 95<OPTION value=\"98\">Windows 98<OPTION value=\"ME\">Windows ME<OPTION value=\"Type9x\">Type 9x<OPTION value=\"2K\">Windows 2000<OPTION value=\"XP\">Windows XP<OPTION value=\"NT\">Windows NT <OPTION value=\"TypeXP\">Type XP</SELECT></td></tr>";
