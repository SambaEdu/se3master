								...
								*/
								...
								if($temoin_mat==1){
									...
									if(strstr($ligne[$cpt],"<LIBELLE_COURT>")){
										...
										$matiere[$i]["libelle_court"]=preg_replace("/[^a-zA-Z0-9¿ƒ¬…» ÀŒœ‘÷Ÿ€‹«Á‡‰‚ÈËÍÎÓÔÙˆ˘˚¸&_. -]/","",html_entity_decode($tabtmp[2]));
									}
								...
								*/
								...
								if($temoin_prof==1){
									...
									if(strstr($ligne[$cpt],"<PRENOM>")){
										...
										$prof[$i]["prenom"]=preg_replace("/[^a-zA-Z0-9¿ƒ¬…» ÀŒœ‘÷Ÿ€‹«Á‡‰‚ÈËÍÎÓÔÙˆ˘˚¸_. -]/","",$tabtmp[2]);
									}
