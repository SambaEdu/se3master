...
function search_doublons_mac ($generer_csv='n') {
	...
	/**
	* Recherche des doublons dans la branche computers: plusieurs noms de machines pour une même adresse MAC

	* @Parametres: $generer_csv: Variable à passer à 'y' pour proposer de générer un CSV (le code correspondant doit exister dans la page cible)
